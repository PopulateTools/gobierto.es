...
El módulo de [visualización de presupuestos](http://localhost:4000/modulos/presupuestos) de Gobierto ofrece una herramienta interactiva para explorar el progreso de la [ejecución presupuestaria](https://pressupost.santfeliu.cat/presupuestos/ejecucion/2017#functional,economic) del municipio.
