...
Como nota final, incluiremos estos gráficos en el [módulo de indicadores](https://madrid.gobierto.es/indicadores) de Gobierto. Los datos los he extraído con Populate Data, una base de datos abiertos que lanzaremos próximamente. Si te interesa, escríbenos a [lets@populate.tools](mailto:lets@populate.tools).
